...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
"use strict";function _classCallCheck(r,e){if(!(r instanceof e))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function r(r,e){for(var n=0;e.length>n;n++){var t=e[n];t.enumerable=t.enumerable||!1,t.configurable=!0,"value"in t&&(t.writable=!0),Object.defineProperty(r,t.key,t)}}return function(e,n,t){return n&&r(e.prototype,n),t&&r(e,t),e}}(),Sha256=function(){function r(){_classCallCheck(this,r)}return _createClass(r,null,[{key:"hash",value:function(e,n){function t(r){try{return(new TextEncoder).encode(r,"utf-8").reduce(function(r,e){return r+String.fromCharCode(e)},"")}catch(e){return unescape(encodeURIComponent(r))}}function a(r){var e=r.replace(" ","");return""==e?"":e.match(/.{2}/g).map(function(r){return String.fromCharCode(parseInt(r,16))}).join("")}var o={msgFormat:"string",outFormat:"hex"},u=Object.assign(o,n);switch(u.msgFormat){default:case"string":e=t(e);break;case"hex-bytes":e=a(e)}var c=[1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298],i=[1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225];e+=String.fromCharCode(128);for(var f=e.length/4+2,l=Math.ceil(f/16),h=Array(l),s=0;l>s;s++){h[s]=Array(16);for(var v=0;16>v;v++)h[s][v]=e.charCodeAt(64*s+4*v+0)<<24|e.charCodeAt(64*s+4*v+1)<<16|e.charCodeAt(64*s+4*v+2)<<8|e.charCodeAt(64*s+4*v+3)<<0}var R=8*(e.length-1)/Math.pow(2,32),C=8*(e.length-1)>>>0;h[l-1][14]=Math.floor(R),h[l-1][15]=C;for(var d=0;l>d;d++){for(var y=Array(64),m=0;16>m;m++)y[m]=h[d][m];for(var g=16;64>g;g++)y[g]=r.σ1(y[g-2])+y[g-7]+r.σ0(y[g-15])+y[g-16]>>>0;for(var p=i[0],O=i[1],T=i[2],k=i[3],b=i[4],w=i[5],A=i[6],j=i[7],x=0;64>x;x++){var S=j+r.Σ1(b)+r.Ch(b,w,A)+c[x]+y[x],M=r.Σ0(p)+r.Maj(p,O,T);j=A,A=w,w=b,b=k+S>>>0,k=T,T=O,O=p,p=S+M>>>0}i[0]=i[0]+p>>>0,i[1]=i[1]+O>>>0,i[2]=i[2]+T>>>0,i[3]=i[3]+k>>>0,i[4]=i[4]+b>>>0,i[5]=i[5]+w>>>0,i[6]=i[6]+A>>>0,i[7]=i[7]+j>>>0}for(var F=0;i.length>F;F++)i[F]=("00000000"+i[F].toString(16)).slice(-8);var _="hex-w"==u.outFormat?" ":"";return i.join(_)}},{key:"ROTR",value:function(r,e){return e>>>r|e<<32-r}},{key:"Σ0",value:function(e){return r.ROTR(2,e)^r.ROTR(13,e)^r.ROTR(22,e)}},{key:"Σ1",value:function(e){return r.ROTR(6,e)^r.ROTR(11,e)^r.ROTR(25,e)}},{key:"σ0",value:function(e){return r.ROTR(7,e)^r.ROTR(18,e)^e>>>3}},{key:"σ1",value:function(e){return r.ROTR(17,e)^r.ROTR(19,e)^e>>>10}},{key:"Ch",value:function(r,e,n){return r&e^~r&n}},{key:"Maj",value:function(r,e,n){return r&e^r&n^e&n}}]),r}();"undefined"!=typeof module&&module.exports&&(module.exports=Sha256);
