...
$.fn.range = function(parameters) {
  ...
  $allModules
    .each(function() {
          ...
          var minValWidthInPx = (($(element).closest('div').width() / max) * min);
          
					$(element).html("<div class='min-val' style='width:"+minValWidthInPx+"px'><div class='min-label'>Min. "+min+" GB</div></div><div class='inner' style='margin-left:"+minValWidthInPx+"px'><div class='max-label'>Max. "+max+" GB</div><div class='track'></div><div class='track-fill'></div><div class='thumb'><div class='bubble'></div></div></div>");
