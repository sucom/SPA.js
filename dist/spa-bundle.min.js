...
function _clearSpaValidateMsg(a){return spa._validate._showValidateMsg(a),!0}spa._validateDefaults={required:"Required",digits:"Digits",numbers:"Numbers",integer:"Integer",alphabet:"Alpha",alphanumeric:"AlphaNumeric",pattern:"PatternMatch",range:"ValueRange",fixedlength:"Lengths",minlength:"LengthMin",maxlength:"LengthMax",email:"Email",url:"Url",date:"Date",cardno:"CardNo",ipv4:"IPv4",ipv6:"IPv6",ipaddress:"IP",subnetmask:"Subnet",phoneUS:"PhoneUS",wordsize:"WordSize",compare:"Compare"},spa._validate={_isOnOfflineValidation:!1,_validateAlertTemplate:'<div class="errortxt error-txt break-txt" data-i18n=""></div>',_offlineValidationRules:{},_fn:{Required:function(a){var e=spa.getElValue(a);return!spa.isBlank(e)},Digits:function(a){var e=$(a).val(),t=0===e.length||/^\d+$/.test(e);return t},Numbers:function(a){var e=$(a).val(),t=0===e.length||/^-?(?:\d+|\d{1,3}(?:,\d{3})+)?(?:\.\d+)?$/.test(e);return t},Integer:function(a){var e=$(a).val(),t=0===e.length||/^-?\d+$/.test(e);return t},Alpha:function(a){var e=$(a).val(),t=0===e.length||!/[^a-z]/gi.test(e);return t},AlphaNumeric:function(a){var e=$(a).val(),t=0===e.length||!/[^a-z0-9]/gi.test(e);return t},PatternMatch:function(a){var e=$(a).val(),t=0===e.length;if(!t){var n=RegExp($(a).data("validatePattern"),$(a).data("validatePatternOptions").replace(/!/g,""));t=n.test(e),$(a).data("validatePatternOptions").indexOf("!")>=0&&(t=!t)}return t},ValueRange:function(a){var e=$(a).val(),t=0===e.length;if(!t&&(t=!1,/^-?(?:\d+|\d{1,3}(?:,\d{3})+)?(?:\.\d+)?$/.test(e))){var n=spa.toFloat(e),i=(" "+($(a).data("validateRange")||"")+": ").split(":"),r=!spa.isBlank(i[0]),l=!spa.isBlank(i[1]),s=spa.toFloat(i[0]),u=spa.toFloat(i[1]);r&&l?t=n>=s&&u>=n:r?t=n>=s:l&&(t=u>=n)}return t},LengthMin:function(a){var e=$(a).val(),t=spa.toInt($(a).attr("minlength")),n=e.length>=t;return n},LengthMax:function(a){var e=$(a).val(),t=spa.toInt($(a).attr("maxlength")),n=t>=e.length;return n},Lengths:function(a){var e=$(a).val(),t=e.length,n=spa.toInt($(a).attr("minlength")),i=spa.toInt($(a).attr("maxlength")),r=t>=n&&i>=t;return r},WordSize:function(a){var e=$(a).val(),t=_.max(_.map((""+e).replace(/[-\n]/g," ").split(" "),function(a){return a.length})),n=spa.toInt($(a).data("validWordSize"))||20,i=n>=t;return i},Email:function(a){var e=$(a).val(),t=0===e.length;return t||(t=(/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))$/i.test(e)||/[a-z0-9!#$%&'*+\/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+\/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?/i.test(e))&&/[a-z0-9]/i.test(e[e.length-1])),t},Url:function(a){var e=$(a).val(),t=0===e.length;return t||(t=/^(https?|s?ftp):\/\/(((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/(([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(#((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?$/i.test(e)),t},Date:function(a){var e=$(a).val(),t=0===e.length;if(!t){t=!1;var n,i,r,l,s=["","JAN","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEP","OCT","NOV","DEC"],u=["","JANUARY","FEBRUARY","MARCH","APRIL","MAY","JUNE","JULY","AUGUST","SEPTEMBER","OCTOBER","NOVEMBER","DECEMBER"],F=$(a).data("validateFormat")||"YMD",d="^\\d{1,2}[\\/\\-\\.]\\d{1,2}[\\/\\-\\.]\\d{4}$",o=e.replace(/[^a-z]/gi,"");o&&(l=_.indexOf(s,o.toUpperCase()),0>=l&&(l=_.indexOf(u,o.toUpperCase())),l>0&&(e=e.replace(RegExp(o,"gi"),l))),e=e.replace(/[^0-9]/g," ").normalizeStr().replace(/ /g,"/");var f=e.split("/");switch(F.toUpperCase()){case"YMD":d="^\\d{4}[\\/\\-\\.]\\d{1,2}[\\/\\-\\.]\\d{1,2}$",n=f[0],i=f[1],r=f[2];break;case"MDY":i=f[0],r=f[1],n=f[2];break;case"DMY":r=f[0],i=f[1],n=f[2]}if(RegExp(d,"").test(e)){r=parseInt(r,10),i=parseInt(i,10),n=parseInt(n,10);var c=new Date(n,i-1,r);t=c.getFullYear()===n&&c.getMonth()===i-1&&c.getDate()===r}}return t},CardNo:function(a){var e=$(a).val(),t=0===e.length;if(!t)if(/[^0-9 \-]+/.test(e))t=!1;else{for(var n=0,i=0,r=!1,l=e.replace(/\D/g,""),s=l.length-1;s>=0;s--){var u=l.charAt(s);i=parseInt(u,10),r&&(i*=2)>9&&(i-=9),n+=i,r=!r}t=0===n%10}return t},IPv4:function(a){var e=$(a).val(),t=0===e.length;return t||(t=/^(25[0-5]|2[0-4]\d|[01]?\d\d?)\.(25[0-5]|2[0-4]\d|[01]?\d\d?)\.(25[0-5]|2[0-4]\d|[01]?\d\d?)\.(25[0-5]|2[0-4]\d|[01]?\d\d?)$/i.test(e)&&_.every(e.split("."),function(a){return a.length>1?!a.beginsWithStr("0"):!0})),t},IPv6:function(a){var e=$(a).val(),t=0===e.length;return t||(t=/^((([0-9A-Fa-f]{1,4}:){7}[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){6}:[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){5}:([0-9A-Fa-f]{1,4}:)?[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){4}:([0-9A-Fa-f]{1,4}:){0,2}[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){3}:([0-9A-Fa-f]{1,4}:){0,3}[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){2}:([0-9A-Fa-f]{1,4}:){0,4}[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){6}((\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b)\.){3}(\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b))|(([0-9A-Fa-f]{1,4}:){0,5}:((\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b)\.){3}(\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b))|(::([0-9A-Fa-f]{1,4}:){0,5}((\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b)\.){3}(\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b))|([0-9A-Fa-f]{1,4}::([0-9A-Fa-f]{1,4}:){0,5}[0-9A-Fa-f]{1,4})|(::([0-9A-Fa-f]{1,4}:){0,6}[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){1,7}:))$/i.test(e)),t},IP:function(a,e){var t=$(a).val(),n=0===t.length;if(!n){var i=t,r=spa.toInt($(a).data("validateIpaddressOctates")||4)-1,l=RegExp("^(([01]?[0-9]?[0-9]|2([0-4][0-9]|5[0-5]))\\.){"+r+"}([01]?[0-9]?[0-9]|2([0-4][0-9]|5[0-5]))$","g");n=l.test(i)&&_.every(i.split("."),function(a){return a.length>1?!a.beginsWithStr("0"):!0}),spa._validate._showValidateMsg(a,e,n);var s=$(a).data("validateIpaddressClass");if(n&&s){var u=i.split("."),F={A:{oct1:{B:0,E:127},oct2:{B:0,E:256},oct3:{B:0,E:256},oct4:{B:1,E:255}},B:{oct1:{B:127,E:192},oct2:{B:1,E:256},oct3:{B:0,E:256},oct4:{B:0,E:255}},C:{oct1:{B:191,E:224},oct2:{B:0,E:256},oct3:{B:1,E:256},oct4:{B:1,E:255}},D:{oct1:{B:223,E:240},oct2:{B:0,E:256},oct3:{B:0,E:256},oct4:{B:0,E:256}},E:{oct1:{B:239,E:255},oct2:{B:0,E:256},oct3:{B:0,E:256},oct4:{B:0,E:255}}};n=1*u[0]>F[s].oct1.B&&F[s].oct1.E>1*u[0]?1*u[1]>=F[s].oct2.B&&F[s].oct2.E>1*u[1]?1*u[2]>=F[s].oct3.B&&F[s].oct3.E>1*u[2]?1*u[3]>F[s].oct4.B&&F[s].oct4.E>1*u[3]?!0:!1:!1:!1:!1,spa._validate._showValidateMsg(a,e,n)}}return n},Subnet:function(a){var e=$(a).val(),t=0===e.length;if(!t){var n=RegExp("^((128|192|224|240|248|252|254)\\.0\\.0\\.0)|(255\\.(((0|128|192|224|240|248|252|254)\\.0\\.0)|(255\\.(((0|128|192|224|240|248|252|254)\\.0)|255\\.(0|128|192|224|240|248|252|254)))))$");t=n.test(e)&&_.every(e.split("."),function(a){return a.length>1?!a.beginsWithStr("0"):!0})}return t},PhoneUS:function(a){var e=$(a).val(),t=0===e.length;return t||(t=e.length>9&&e.match(/^(\+?1-?)?(\([2-9]\d{2}\)|[2-9]\d{2})-?[2-9]\d{2}-?\d{4}$/)),t},Compare:function(a){var e=!0,t=$(a).val(),e=0===t.length;if(!e){var n,i=$(a),r=i.data(),l=spa.toJSON(r.validateCompare||"{}");if(!spa.isBlank(l)&&l.target){n=$(l.target);var s=l.valid||"=",u=spa.getElValue(a),F=spa.getElValue(n);if(("number".equalsIgnoreCase(l.type)||s.indexOf("<")>=0||s.indexOf(">")>=0)&&(u=spa.toFloat(u),F=spa.toFloat(F)),"date".equalsIgnoreCase(l.type));else switch(s){case"!=":e=u!=F;break;case"!==":e=u!==F;break;case"===":e=u===F;break;case">":e=u>F;break;case"<":e=F>u;break;case">=":e=u>=F;break;case"<=":e=F>=u;break;default:e=u==F}}}return e}},_showValidateMsg:function(a,e,t,n){e=e||"",arguments.length>2&&_.isString(t)&&(n=t),arguments.length>2&&_.isBoolean(t)&&t&&(e=""),n=n||spa._validate._validateAlertTemplate;var i=!n.beginsWithStrIgnoreCase("<");a=$($(a).data("validateMsgEl")||a).get(0);var r=$(a),l=r.data("errorClassTarget"),s=l?r.closest(l):r.parent();spa._validate._isOnOfflineValidation||(s[t===!1?"addClass":"removeClass"]("validation-error"),spa.updateTrackFormCtrls(a.form));var u=i?$(n):$(a).next(),F="";if($(u).attr("class")===$(n).attr("class")||i){if(e.beginsWithStrIgnoreCase("i18n:")){var d=e.replace(/i18n:/gi,"");F="{html:'"+d+"'}",e=$.i18n.prop(d)}spa._validate._isOnOfflineValidation||($(u).data("i18n",F),$(u).html(e))}else spa.isBlank(e)||($(n).insertAfter($(a)),spa._validate._showValidateMsg(a,e,t,n));return t},expose:function(a){return a=a||{},Object.keys(spa._validateDefaults).forEach(function(e){a[e]=spa._validate._fn[spa._validateDefaults[e]]}),a}};var _check=spa._validate.expose();spa.initValidation=spa.initDataValidation=function(a){spa.console.log(">>>>> initDataValidation request for context:"+a);var e=function(a){return a=a||{},_.each(_.keys(a),function(e){0==e.indexOf("on")&&e.indexOf("_")>0&&(_.each(e.split("_"),function(t){0>t.indexOf("on")&&(t="on"+t),a[t]?_.isArray(a[t])?a[t].push(a[e]):a[t]=[a[t],a[e]]:a[t]=[a[e]]}),delete a[e])}),a};a=a||"body";var t=$(a),n=t.data("validateElFilter")||"",i=e(spa.toJSON(t.data("validateCommon")||"{}"));spa.console.log("keys Of commonValidateRules"),spa.console.log(_.keys(i));var r,l,s,u,F,d=(t.data("validateForm")||t.data("validateScope")||"").replace(/onRender/i,"").replace(/[^a-zA-Z0-9]/g,"");if(spa.isBlank(d)){var o=a.replace(/[^a-zA-Z0-9]/g,"");spa._validate._offlineValidationRules.hasOwnProperty(o)||(d=o)}spa.console.log("offlineValidationKey: "+d);var f=!spa.isBlank(d);f&&(spa._validate._offlineValidationRules[d]={rules:{}}),t.find(n+"[data-validate]").each(function(a,t){var n=$(t).prop("id"),o={},c=$(t).data("validate");if(c&&0>c.indexOf("{")){var p=($(t).data("validateEvents")||"onBlur").replace(/[^a-z]/gi," ").normalizeStr().replace(/ /g,"_"),v=",offline:"+($(t).data("validateOffline")||"false"),g="{fn:"+c.replace(/[,;]/," ").normalizeStr().replace(/ /g,v+"},{fn:")+v+"}";c="{"+p+":["+g+"]}"}o=e(spa.toJSON(c)),spa.console.log(c),_.each(_.keys(i),function(a){var e=i[a];_.isArray(e)||(e=[e]),e.reverse(),_.each(e,function(e){if(r=!0,l="<",u=e.offline||!1,s=!1,e.el){var t=e.el.replace(/ /g,"").split(","),i=e.el.replace(/[< >!]/g,"").split(","),d=_.indexOf(i,n);r=d>=0,r&&(l=t[d].indexOf(">")>=0?">":"<",s=t[d].indexOf("!")>=0)}else e.ex&&(r=0>_.indexOf(e.ex.replace(/[< >!]/g,"").split(","),n));r&&(F=_.omit(e,["el","ex"]),s&&(F=_.extend(F,{offline:!u})),o[a]||(o[a]=[]),o[a]="<"===l?_.union([F],o[a]):_.union(o[a],[F]))})}),_.each(_.keys(o),function(a){var e=a.substring(2,3).toLowerCase()+a.substring(3);spa.console.log("settingup event on["+e+"]..."),_.isArray(o[a])||(o[a]=[o[a]]),spa.console.log(o),f&&_.each(o[a],function(a){spa.is(a,"array")||(a=[a]),_.each(a,function(a){if(a.offline){var e={fn:a.fn,msg:a.msg};spa._validate._offlineValidationRules[d].rules[n]||(spa._validate._offlineValidationRules[d].rules[n]=[]),0>_.indexOf(spa._validate._offlineValidationRules[d].rules[n],e)&&spa._validate._offlineValidationRules[d].rules[n].push(e)}})}),spa.console.log("registering an event: "+a),a.beginsWithStrIgnoreCase("on")&&!"test".equalsIgnoreCase(e)&&$(t).on(e,function(){var e,t,n=this;_.every(o[a],function(a){return _.isArray(a)?_.every(a,function(a){return e=a.fn,spa.is(e,"string")&&(e=spa.findSafe(window,e)),spa.is(e,"function")||console.error("data-validate-function Not Found: "+a.fn),t=a.msg||$(n).data("validateMsg")||"",spa._validate._showValidateMsg(n,t,spa.is(e,"function")?e.call(n,n,t):!1)}):(e=a.fn,spa.is(e,"string")&&(e=spa.findSafe(window,e)),spa.is(e,"function")||console.error("data-validate-function Not Found: "+a.fn),t=a.msg||$(n).data("validateMsg")||"",spa._validate._showValidateMsg(n,t,spa.is(e,"function")?e.call(n,n,t):!1))})})})})},spa.validateForm=spa.doDataValidation=function(a,e,t){var n,i=a.replace(/[^a-zA-Z0-9]/g,""),r="#"+a.replace(/#/g,""),l=$(r),s=[];if(spa._validate._offlineValidationRules[i]){var u=spa._validate._offlineValidationRules[i].rules,F=function(a){var e,t,n=l.find("#"+a),i=spa.toBoolean(n.data("ignoreValidationIfInvisible"))&&!n.is(":visible");return i||(i=_.every(u[a],function(a){t=a.fn,spa.is(t,"string")&&(t=spa.findSafe(window,t)),spa.is(t,"function")||console.error("data-validate-function Not Found: "+a.fn),e=a.msg||n.data("validateMsg")||"";var i=spa._validate._showValidateMsg(n,e,spa.is(t,"function")?t.call(n,n,e):!1);if(!i){var r={errcode:2,el:n,fn:a.fn,msg:e};s.push(r)}return i})),i};$.isEmptyObject(u)?s={errcode:1,errmsg:"Rules not found in scope ["+a+"]."}:(spa._validate._isOnOfflineValidation=!e,n=_.every(_.keys(u),function(a){return F(a)||t}),spa._validate._isOnOfflineValidation=!1)}else s={errcode:1,errmsg:"Scope not found."};return s},spa.updateValidation=function(a,e,t,n){spa._validate._showValidateMsg(a,e,t,n)};
